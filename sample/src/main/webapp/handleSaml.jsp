                        ...
                        <div class="post-body">
                            <%
                                ...
                                for (Attribute attribute : credential.getAttributes()) {
                                    ...
                                    String values = credential.getAttributeAsString(name);
                                    session.setAttribute(name, values);
                                    System.out.println("name : "+ name);
                                }
                                System.out.println("After for loop");
                                System.out.println(credential.getAttributeAsString("urn:oid:0.9.2342.19200300.100.1.1"));
                                System.out.println(credential.getAttributeAsString("uid"));
                                System.out.println(credential.getAttributeAsString("urn:oid:1.3.6.1.4.1.5923.1.1.1.6"));
                                System.out.println(credential.getAttributeAsString("eduPersonPrincipalName"));
                            %>
                            <p>
                            <table>
                                <tr>
